...
1. Update `football-logos` to the latest release.
2. If it still fails, [open a GitHub issue](https://github.com/julianYaman/football-logos/issues) with the `country` and `club` slugs you used.
